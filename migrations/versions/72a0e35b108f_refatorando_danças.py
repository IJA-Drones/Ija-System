...
def upgrade():
    ...
    with op.batch_alter_table('dji_flight_kml_routes', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_dji_flight_kml_routes_flight_record_id'), ['flight_record_id'], unique=True)
        batch_op.drop_index(batch_op.f('ix_dji_flight_kml_routes_route_code'))
        batch_op.create_index(batch_op.f('ix_dji_flight_kml_routes_route_code'), ['route_code'], unique=True)
        batch_op.create_index(batch_op.f('ix_dji_flight_kml_routes_file_sha256'), ['file_sha256'], unique=True)
...
def downgrade():
    ...
    with op.batch_alter_table('dji_flight_kml_routes', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_dji_flight_kml_routes_route_code'))
        batch_op.create_index(batch_op.f('ix_dji_flight_kml_routes_route_code'), ['route_code'], unique=False)
        batch_op.drop_index(batch_op.f('ix_dji_flight_kml_routes_flight_record_id'))
        batch_op.create_index(batch_op.f('ix_dji_flight_kml_routes_flight_record_id'), ['flight_record_id'], unique=False)
        batch_op.create_unique_constraint(batch_op.f('dji_flight_kml_routes_route_code_key'), ['route_code'], postgresql_nulls_not_distinct=False)
        batch_op.create_unique_constraint(batch_op.f('dji_flight_kml_routes_flight_record_id_key'), ['flight_record_id'], postgresql_nulls_not_distinct=False)
        batch_op.create_unique_constraint(batch_op.f('dji_flight_kml_routes_file_sha256_key'), ['file_sha256'], postgresql_nulls_not_distinct=False)
