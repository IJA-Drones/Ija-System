...
from app.modules.agenda_notificacoes import (
    agora_brasilia_naive,
    criar_notificacao,
    register_routes as register_agenda_notificacoes_routes,
)
...
def _run_postgres_backup():
    ...
    try:
        ...
        print(f"Erro critico no backup real: {e}")
        raise e
...
def _list_backups():
    ...
    try:
        ...
        print(f"Erro ao listar Dropbox (Pasta pode estar vazia): {e}")
